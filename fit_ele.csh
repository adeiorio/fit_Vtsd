...
combine -M MaxLikelihoodFit datac_electron/ST_tch_sd/ST_tch_sd_shape.txt --saveShapes --saveWithUncertainties --plot --robustFit 1 --customStartingPoint --out electron
...
combine datac_electron/ST_tch_sd/ST_tch_sd_shape.txt -M MultiDimFit --poi r --algo=grid --points=80 --autoRange 1 -n ST_tch_sd_ele
...
#combine -M MaxLikelihoodFit datac_electron/ST_tch/ST_tch_shape.txt --saveShapes --saveWithUncertainties --plot --robustFit 1 --customStartingPoint --out electron
#echo "Making pull distributions ..."
#./make_pulls.sh electron/mlfit.root
#cat pulls.txt
#python pulls.py -f pulls.txt --out electron
#combine -M Asymptotic -S 1 -t 1 -n ST_tch_ele datac_electron/ST_tch/ST_tch_shape.txt
#combine datac_electron/ST_tch/ST_tch_shape.txt -M MultiDimFit --poi r --algo=grid --points=80 --autoRange 1 -n ST_tch_ele
