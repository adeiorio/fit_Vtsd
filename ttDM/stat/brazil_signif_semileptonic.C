...
#include "include/signif_semileptonic_count.h"
#include "include/signif_semileptonic_shape.h"
...
void brazil_signif_semileptonic() {
  system("mkdir -p plots");
  string method[] = { "count", "shape" };
  for(int i = 0; i < 2; ++i)
    brazil_signif_v(method[i], "semileptonic");
}
