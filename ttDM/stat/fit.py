...
#    os.system("combine -M MaxLikelihoodFit " + metadatacard_out + ".txt --saveShapes --saveWithUncertainties --plots --saveNormalizations --robustFit 1 --customStartingPoint --stepSize 0.004 --initFromBonly --out " + opt.lep + " --profilingMode all --keepFailures ")
    os.system("combine -M MaxLikelihoodFit " + metadatacard_out + ".txt --saveShapes --saveWithUncertainties --plots --saveNormalizations --robustFit 1 --customStartingPoint --stepSize 0.004 --initFromBonly --out " + opt.lep + " --profilingMode all --keepFailures  --autoBoundsPOIs r")
# --minos=all slower but better
    ...
    os.system("python rateParam.py -L "+opt.lep+" "+opt.lep+"/mlfit.root >& "+opt.lep+"/infoPF_"+opt.process+"_"+opt.lep+".log ")
...
#    os.system("combine " + metadatacard_out + ".txt -M MultiDimFit --redefineSignalPOI q2ST_tch --freezeNuisances r --startFromPreFit 1 --stepSize 0.004 --algo=grid --autoRange 3 --points=60  -n " + opt.process + opt.lep)
    os.system("combine " + metadatacard_out + ".txt -M MultiDimFit --poi r --startFromPreFit 1 --stepSize 0.004 --algo=grid --autoRange 3 --points=600  -n " + opt.process + opt.lep)
