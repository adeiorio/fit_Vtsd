...
combine -M MaxLikelihoodFit datac_muele/ST_tch_sd/ST_tch_sd_shape.txt --saveShapes --saveWithUncertainties --plot --robustFit 1 --customStartingPoint --out mu_ele --saveNLL --keepFailures --autoBoundsPOIs r
...
combine datac_muele/ST_tch_sd/ST_tch_sd_shape.txt -M MultiDimFit --poi r --algo=grid --points=80 --autoBoundsPOIs r --autoRange 1 -n ST_tch_sd_muele
