...
combine -M MaxLikelihoodFit datac_muon/ST_tch_sd/ST_tch_sd_shape.txt --saveShapes --saveWithUncertainties --plot --robustFit 1 --customStartingPoint --out muon --autoBoundsPOIs r
...
combine datac_muon/ST_tch_sd/ST_tch_sd_shape.txt -M MultiDimFit --poi r --algo=grid --points=80 --autoRange 1 --autoBoundsPOIs r -n ST_tch_sd_muon 
