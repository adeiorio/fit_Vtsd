...
const unsigned int nCat = 4;
const string catName[nCat] = { "semileptonic_tag", "semileptonic_untag", 
			       "fullhadronic_tag", "fullhadronic_untag" };
const string fileCatName[nCat] = { "semileptonic", "semileptonic", 
				   "fullhadronic","fullhadronic" };
const string varName[nCat] = { "metFinal_tag", "metFinal_untag","metFinal_tag", "metFinal_untag" };
// cuts are expressed as bin number
const double metBinCut[nCat] = { 5, 5, 5, 5 };
...
const string shortName[nSamples] = { "TT", "SingleTop", "DY", "ZToNuNu", "WJets", "QCD",
				     "DMtt_sc_Mchi1Mphi10", "DMtt_sc_Mchi10Mphi10",
				     "DMtt_sc_Mchi1Mphi20",
				     "DMtt_sc_Mchi1Mphi50", "DMtt_sc_Mchi50Mphi50",
				     "DMtt_sc_Mchi1Mphi200", "DMtt_sc_Mchi50Mphi200", "DMtt_sc_Mchi150Mphi200", 
				     "DMtt_sc_Mchi50Mphi300",
				     "DMtt_sc_Mchi1Mphi500", "DMtt_sc_Mchi150Mphi500", "DMtt_sc_Mchi500Mphi500",
				     "DMtt_sc_Mchi1Mphi1000", "DMtt_sc_Mchi150Mphi1000" 
};
...
const string crNames_1[] = { /* "outtop",  "SR_1lep" */ "CR3" };
const string crSamples_1[] = { /* "QCD", */ "TT" };
const unsigned int nCr[nCat] = { sizeof(crNames_0)/sizeof(string), sizeof(crNames_0)/sizeof(string),
				 0 /*sizeof(crNames_1)/sizeof(string)*/ , sizeof(crNames_1)/sizeof(string) };
const string * crNames[nCat] = { crNames_0, crNames_0, 
				 crNames_1, crNames_1 };
const string * crSamples[nCat] = { crSamples_0, crSamples_0, 
				   crSamples_1, crSamples_1 };
...
void plotMEThist(bool syst, int cat, bool ctrlRegions) {
  ...
  for(unsigned int iCat = iCatMin; iCat < iCatMax; ++iCat) {  
    ...
    cout << ">>> retrieving syst. files" << endl;
    ...
    if(syst) {
      for(unsigned int s = 0; s < nSyst; ++s) {
	systParms.push_back(new RooRealVar(systName[s].c_str(), systName[2].c_str(), -5, 5));
      }
    }
